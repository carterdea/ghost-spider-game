 ...
 * patrols at the highest threat scale in the game. The hero starts at the far
 * end of the approach roof, with the first tower already inside web reach.
 */
export const bridgeLineFinale = {
  ...
  buildingRows: [
    ...
    { x: 900, width: 480, roofY: 580, kind: "tower" },
